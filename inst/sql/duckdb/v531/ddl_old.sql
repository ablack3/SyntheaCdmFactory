...
DROP TABLE IF EXISTS main.observation_period;
...
DROP TABLE IF EXISTS main.visit_occurrence;
...
DROP TABLE IF EXISTS main.condition_occurrence;
...
DROP TABLE IF EXISTS main.drug_exposure;
...
DROP TABLE IF EXISTS main.procedure_occurrence;
...
DROP TABLE IF EXISTS main.device_exposure;
...
DROP TABLE IF EXISTS main.observation;
...
DROP TABLE IF EXISTS main.death;
...
DROP TABLE IF EXISTS main.note_nlp;
...
DROP TABLE IF EXISTS main.specimen;
...
DROP TABLE IF EXISTS main.fact_relationship;
...
DROP TABLE IF EXISTS main.care_site;
...
DROP TABLE IF EXISTS main.provider;
...
DROP TABLE IF EXISTS main.payer_plan_period;
...
DROP TABLE IF EXISTS main.cost;
...
DROP TABLE IF EXISTS main.drug_era;
...
DROP TABLE IF EXISTS main.dose_era;
...
DROP TABLE IF EXISTS main.condition_era;
...
DROP TABLE IF EXISTS main.metadata;
...
DROP TABLE IF EXISTS main.cdm_source;
...
DROP TABLE IF EXISTS main.cohort_definition;
...
DROP TABLE IF EXISTS main.attribute_definition;
CREATE TABLE main.attribute_definition (
