...
WITH cteConditionTarget (condition_occurrence_id, person_id, condition_concept_id, condition_start_date, condition_end_date)  AS (
	SELECT
		...
		, COALESCE(NULLIF(co.condition_end_date,NULL), (condition_start_date + 1*INTERVAL'1 day')) AS condition_end_date
...
ANALYZE tmp_ce
;
INSERT INTO main.condition_era (condition_era_id,person_id, condition_concept_id, condition_era_start_date, condition_era_end_date, condition_occurrence_count)
SELECT * FROM tmp_ce;